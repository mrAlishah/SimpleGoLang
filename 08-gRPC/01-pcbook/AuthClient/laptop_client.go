...
//we define a function to create a new laptop client object. It will receive a client connection as input. And use that connection to make a new laptop service client
